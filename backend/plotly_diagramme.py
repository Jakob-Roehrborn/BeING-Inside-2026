...
def plot_zeitreihe_optimiert(df, spalten, tage=365, start_tag=0, glättung_stunden=24, title = 'Plott'):
    ...
    fig = px.line(
        ...
        y=spalten,
        title= title,
        template='plotly_white' #"plotly_dark" # Dunkel: slate, cyborg Hell: plotly, plotly_white, ggplot2 Einfach: seaborn, none
    )
    ...
    fig.update_layout(hovermode="x unified", xaxis_title="Monat", yaxis_title = 'Preis in Euro')
    fig.show()
    return fig
